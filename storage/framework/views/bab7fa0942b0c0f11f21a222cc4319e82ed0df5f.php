...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="sex" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Sexe')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="skill" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Skill')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\b1keroll\resources\views/auth/register.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="description" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Descripción')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="unevenness" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Desnivel')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="number_of_competitors" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Número de participantes')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="length" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Longitud')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="start_date" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Fecha')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="start_time" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Hora')); ?></label>

                            <div class="col-md-6">
                                <input id="start_time" type="time" class="form-control <?php $__errorArgs = ['start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="start_point" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Punto de salida')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="price" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Precio')); ?></label>

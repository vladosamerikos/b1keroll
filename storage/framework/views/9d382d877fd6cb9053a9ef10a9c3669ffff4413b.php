...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Crear cursa')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="map_frame" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Enllace al frame')); ?></label>

                            <div class="col-md-6">
                                <input id="map_frame" type="text" class="form-control <?php $__errorArgs = ['map_frame'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="unevenness" class="col-md-4 col-form-label text-md-end"><?php echo e(__('unevenness')); ?></label>

                            <div class="col-md-6">
                                <input id="unevenness" type="text" class="form-control <?php $__errorArgs = ['unevenness'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="number_of_competitors" class="col-md-4 col-form-label text-md-end"><?php echo e(__('number_of_competitors')); ?></label>

                            <div class="col-md-6">
                                <input id="number_of_competitors" type="number" class="form-control <?php $__errorArgs = ['number_of_competitors'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="length" class="col-md-4 col-form-label text-md-end"><?php echo e(__('length')); ?></label>

                            <div class="col-md-6">
                                <input id="length" type="number" step="0.01" class="form-control <?php $__errorArgs = ['length'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="start_date" class="col-md-4 col-form-label text-md-end"><?php echo e(__('start_date')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="start_time" class="col-md-4 col-form-label text-md-end"><?php echo e(__('start_time')); ?></label>

                            <div class="col-md-6">
                                <input id="start_time" type="number" step="0.01" class="form-control <?php $__errorArgs = ['start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="start_point" class="col-md-4 col-form-label text-md-end"><?php echo e(__('start_point')); ?></label>

                            <div class="col-md-6">
                                <input id="start_point" type="text" class="form-control <?php $__errorArgs = ['start_point'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\b1keroll\resources\views/admin/raceform.blade.php ENDPATH**/ ?>
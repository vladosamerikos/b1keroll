...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Crear insurance') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('insurance.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="price_per_race" class="col-md-4 col-form-label text-md-end">{{ __('price_per_race') }}</label>

                            <div class="col-md-6">
                                <input id="price_per_race" type="number" class="form-control @error('price_per_race') is-invalid @enderror" name="price_per_race" value="{{ old('price_per_race') }}" required autocomplete="price_per_race" autofocus>
